...
import { DEFAULT_CHAT } from '../store/constants';

type Props = NativeStackScreenProps<SuiviStackParamList, 'Chat'>;
...
export function ChatScreen({ navigation }: Props) {
  ...
  const rows = s.chat.length ? s.chat : DEFAULT_CHAT;
  ...
  return (
    <Screen bg="#EEF4F5">
      <View style={styles.header}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={styles.name}>Marc · Dépann'Express</Text>
