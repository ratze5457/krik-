...
type Props = NativeStackScreenProps<SuiviStackParamList, 'Assist'>;

export function AssistScreen({ navigation }: Props) {
  const clearDep = useAppStore((s) => s.clearDep);

  const requestOther = () => {
    clearDep();
    (navigation.getParent() as any)?.navigate('Signaler', { screen: 'Select' });
  };
    ...
    <Screen bg={colors.bgAlt}>
      <View style={styles.header}>
        ...
        <View>
          ...
          <Text style={styles.subtitle}>Un souci avec le dépanneur ? On vous aide.</Text>
        </View>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View>
          ...
          <View style={styles.card}>
            <View style={styles.optionRow}>
              ...
              <Text style={styles.optionText}>Le dépanneur ne répond pas</Text>
            </View>
            <View style={styles.optionRow}>
        ...
        <View>
          ...
          <Pressable onPress={requestOther} style={styles.resolveCard}>
            <View style={styles.resolveIcon}>
              <SwitchRoleIcon />
            </View>
            <View style={{ flex: 1 }}>
              <Text style={styles.resolveTitle}>M'envoyer un autre dépanneur</Text>
              <Text style={styles.resolveSubtitle}>On annule et on relance une recherche</Text>
            </View>
